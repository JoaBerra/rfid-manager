...
Senast uppdaterad 2026-06-11 — täcker Fas 3 (navigation, ViewModels, spacing) och Fas 4 (i18n, dark mode, MQTT, export, haptik, sök, paginering).
...
│   ├── screens/
│   │   ├── ScanScreen.kt        # Radar, start/stop scan, tag-lista, persist
│   │   ├── SettingsScreen.kt    # Alla inställningar (språk, font, haptik, dark mode, page size, export)
│   │   ├── MqttStatusScreen.kt  # MQTT-status, heartbeat
