...
## Fas 5 — Dokumentation och kvalitet
...
- Uppdatera [[App-Architecture]] med Fas 3 och Fas 4-strukturen.
...
## Fas 6 — Radar-estetik och UI-polish

**Mål:** Förbättra radarvisualiseringen med svep som lämnar avtagande spår efter sig för bättre estetik.

### Acceptanskriterier

#### 6.1 Radar sweep med trail/efterglöd
...
**Senast uppdaterad:** 2026-06-11 (Fas 4 punkt 4.1–4.8 godkända, Fas 6 definierad).
